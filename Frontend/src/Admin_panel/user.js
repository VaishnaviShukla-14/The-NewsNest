...
export default function EnhancedTable() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <h1 style={{textAlign:'center',marginRight:'30px',fontFamily:'Times New Roman'}}>CURRENT USERS</h1>
        <TableContainer style={{marginTop:'40px'}}>
          <Table aria-labelledby="tableTitle" size="medium">
            <TableHead>
              <TableRow>
                <TableCell style={{fontSize:'25px',color:'maroon',fontFamily:'Times New Roman',color:'maroon'}}>NAME</TableCell>
                <TableCell style={{fontSize:'25px',color:'maroon',fontFamily:'Times New Roman',color:'maroon'}}>PHONE</TableCell>
                <TableCell style={{fontSize:'25px',color:'maroon',fontFamily:'Times New Roman',color:'maroon'}}>EMAIL</TableCell>
                <TableCell style={{fontSize:'25px',color:'maroon',fontFamily:'Times New Roman',color:'maroon'}}>ADDRESS</TableCell>
                <TableCell style={{fontSize:'25px',color:'maroon',fontFamily:'Times New Roman',color:'maroon'}}>ADHARCARD NUMBER</TableCell>
                <TableCell style={{fontSize:'25px',color:'maroon',fontFamily:'Times New Roman',color:'maroon'}}>PASSWORD</TableCell>
                <TableCell style={{fontSize:'25px',color:'maroon',fontFamily:'Times New Roman',color:'maroon'}}>ACTIONS</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {Array.isArray(rows) && rows.map((row) => (
