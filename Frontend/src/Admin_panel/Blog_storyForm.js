...
const Blog_storyForm = ({ isVisible, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3001/api/blog_story', formDataToSend, {
        headers: {
  ...
  return (
    <>
      <div style={styles.formContainer}>
        <h2 style={styles.heading}>Blog_Story Form</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.buttonGroup}>
            ...
            <Button type="default" onClick={handleCloseForm} style={styles.closeButton}>
              Close
            </Button>
          </div>
        </form>
