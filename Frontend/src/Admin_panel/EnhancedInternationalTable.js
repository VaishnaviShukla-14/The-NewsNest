...
export default function EnhancedInternationalTable() {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
      <h1 style={{textAlign:'center',marginRight:'36px',fontFamily:'Times New Roman'}}>INTERNATIONAL NEWS TABLE</h1>
        <TableContainer  style={{marginTop:'40px'}}>
          <Table aria-labelledby="tableTitle" size="medium">
            <TableHead>
              <TableRow>
                <TableCell  style={{fontFamily:'Times New Roman',fontSize:'25px',color:'maroon'}}>TITLE</TableCell>
                <TableCell  style={{fontFamily:'Times New Roman',fontSize:'25px',color:'maroon'}}>IMAGE</TableCell>
                <TableCell  style={{fontFamily:'Times New Roman',fontSize:'25px',color:'maroon'}}>ARTICLE</TableCell>
                <TableCell  style={{fontFamily:'Times New Roman',fontSize:'25px',color:'maroon'}}>HIGHLIGHT</TableCell>
