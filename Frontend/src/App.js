...
import ProfileForm from "./Admin_panel/ProfileForm";
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/Thenewsroom" element={<Thenewsroom />} />
          ...
          <Route
            path="/enhancedinternationaltable"
            element={<EnhancedInternationalTable />}
          />
          <Route
            path="/enhancednationaltable"
            element={<EnhancedNationalTable />}
          />
          <Route
            path="/enhancededutable"
            element={<EnhancedEducationalTable />}
          />
          <Route
            path="/enhancedsportstable"
            element={<EnhancedSportsTable />}
          />
          <Route path="/enhancedblogtable" element={<EnhancedBlogTable />} />
          <Route path="/deleteUser" element={<DeletedUsersForm />} />
          <Route path="/blog" element={<Blog />} />
          <Route
            path="/enhancedblog_storytable"
            element={<EnhancedBlog_storyForm />}
          />
